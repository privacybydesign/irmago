...
- `did:jwk` is accepted as an OpenID4VCI cryptographic binding method, and is preferred over `did:key` when an issuer advertises both ([#688](https://github.com/privacybydesign/irmago/issues/688)).
