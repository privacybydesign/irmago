...
func startSession(t *testing.T, request irma.SessionRequest, sessiontype string) (*irma.Qr, irma.FrontendAuthorization) {
	var (
...
func sessionHelperWithFrontendOptions(
	...
	qr, frontendAuth := startSession(t, request, sessiontype)
