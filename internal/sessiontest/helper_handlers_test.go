...
func (h TestHandler) RequestAuthorizationCodeFlowIssuancePermission(request *irma.AuthorizationCodeIssuanceRequest, serverName *irma.RequestorInfo, callback irmaclient.AuthorizationCodeHandler) {
	callback(false, "")
}
