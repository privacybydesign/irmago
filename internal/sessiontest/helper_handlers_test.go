...
func (h TestHandler) RequestAuthorizationCodeFlowIssuancePermission(request *irma.AuthorizationCodeIssuanceRequest, serverName *irma.RequestorInfo, callback irmaclient.PermissionHandler) {
	callback(false, nil)
}
