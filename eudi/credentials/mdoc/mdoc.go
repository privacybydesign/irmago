...
//   - OpenID4VP and DC API — ["…Handover", SHA-256(CBOR(HandoverInfo))], built
//     by eudi/openid4vp/mdoc_dcql. That construction lives there, not here,
//     because this package holds no OpenID4VP knowledge of its own.
