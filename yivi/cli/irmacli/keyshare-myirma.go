...
import (
	...
	"github.com/privacybydesign/irmago/irma/server/keyshare/myirmaserver"
...
var myirmaServerCmd = &cobra.Command{
	...
	Run: func(command *cobra.Command, args []string) {
		...
		if err != nil {
			clihelpers.Die("failed to read configuration", err, Logger)
		}
...
func init() {
	...
	myirmaServerCmd.SetUsageTemplate(clihelpers.HeaderFlagsTemplate)
	headers := map[string]string{}
	clihelpers.SetFlagHeaders("yivi irma keyshare myirmaserver", headers)
