...
import (
	"github.com/privacybydesign/irmago/irma/server/keyshare/tasks"
...
func init() {
	...
	keyshareTaskCmd.SetUsageTemplate(clihelpers.HeaderFlagsTemplate)
	headers := map[string]string{}
	clihelpers.SetFlagHeaders("yivi irma keyshare tasks", headers)
