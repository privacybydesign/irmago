...
func (client *IrmaClient) addCredential(cred *credential) (err error) {
	...
	return client.storage.dbStorage.Transaction(func(tx *clientstorage.Transaction) error {
...
func (client *IrmaClient) remove(id irma.CredentialTypeIdentifier, index int) error {
	...
	err := client.storage.dbStorage.Transaction(func(tx *clientstorage.Transaction) error {
...
func (client *IrmaClient) SetPreferences(pref clientsettings.Preferences) {
	...
	_ = client.storage.dbStorage.StorePreferences(client.Preferences)
	client.applyPreferences()
}
